...
const PrivacyPolicy = () => {
  return (
    <div className='w-full border border-emerald-800 rounded-tl rounded-tr bg-green-100/40 py-6 px-4 mt-8'>
      <article className='text-sm text-neutral-600'>
        ...
        As we deem neMarketingPracticescessary, in our sole discretion, if we believe that you are violating any applicable law, rule or regulation, or are otherwise interfering with another's rights or property, including, without limitation, our rights or property;
